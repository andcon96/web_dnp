...
@if(Session::get('username') == 'Tommy')
<div class="col-md-2 col-sm-2 mb-3 ml-5 input-group" style="float: right;">
  <form action="/loadoldso" method="POST">
      @csrf
          <input type="submit" class="btn bt-action" data-toggle="modal" data-target="#loadingtable" data-backdrop="static" data-keyboard="false"  
          id="btnrefresh" value="Load Old SO"  style="float:right" />
  </form>
</div>
@endif
...
<input type="hidden" id="warehousetemp" value=""/>
      ...
      <form class="form-horizontal" method="POST" id='new' action="editsite" onkeydown="return event.key != 'Enter';">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" id="btnsubmit" class="btn btn-success bt-action" id="e_btnconf">Save</button>
...
$(document).on('click','#btnrefresh',function(){
  ...
  $(document).on('click', '#btnsearch', function() {
    ...
    document.getElementById("warehousetemp").value =warehouse; 
  ...
  $(document).on('click', '.pagination a', function(event) {
    ...
    var sitecode = $('#sitecodetemp').val(); 
    var sitedesc = $('#sitedesctemp').val(); 
    var warehouse = $('#warehousetemp').val(); 
    fetch_data(page, sort_type, column_name, sitecode, sitedesc, warehouse);
