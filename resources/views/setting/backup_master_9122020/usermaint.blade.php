...
<div class="table-responsive col-12">
  ...
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <thead>
      <tr>
        <th class="sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer" width="35%">Name<span id="name_icon"></span></th>
        ...
        <th class="sorting" data-sorting_type="asc" data-column_name="role_desc" style="cursor:pointer" width="15%">Role</th>
        <th class="sorting" data-sorting_type="asc" data-column_name="site_desc" style="cursor:pointer" width="30%">Site</th>
