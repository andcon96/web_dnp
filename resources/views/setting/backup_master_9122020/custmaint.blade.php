			...
			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
				<thead>
					<tr>
						...
						<th class="sorting" data-sorting_type="asc" data-column_name="cust_desc" style="cursor: pointer;width: 15%;">Cust Name</th> 
						<th class="sorting" data-sorting_type="asc" data-column_name="customer_site" style="cursor: pointer;width: 15%;">Site</th> 
						<th class="sorting" data-sorting_type="asc" data-column_name="customer_region" style="cursor: pointer;width: 15%;">Region</th> 
						<th class="sorting" data-sorting_type="asc" data-column_name="cust_top" style="cursor: pointer;width: 10%;">TOP</th>
						<th class="sorting" data-sorting_type="asc" data-column_name="custcredit_limit" style="cursor: pointer;width: 11%;">Credit Limit</th>   
