...
<div class="col-md-2 col-sm-2 mb-3 input-group">
...
<input type="hidden" id="suppcodetemp" value=""/>
<input type="hidden" id="suppdesctemp" value=""/>
  ...
  <div class="table-responsive col-sm-12">
    <table class="table table-bordered" id="dataTable" width="50%" cellspacing="0">
      <thead>
        <tr>
          <th width="10%" class="sorting" data-sorting_type="asc" data-column_name="supp_code" style="cursor: pointer">Supplier Code</th>
          <th width="20%" class="sorting" data-sorting_type="asc" data-column_name="supp_desc" style="cursor: pointer">Supplier Description</th>
          <th width="10%">Telepon Supplier</th>
	  <th width="10%">Site</th>
        </tr>
      </thead>
      <tbody>
...
<script>
  ...
  $(document).on('click', '#btnsearch', function() {
    ...
    document.getElementById("suppcodetemp").value=suppcode;    
    document.getElementById("suppdesctemp").value=suppdesc;
  ...
  $(document).on('click', '.pagination a', function(event) {
    ...
    var column_name = $('#hidden_column_name').val();
    var sort_type = $('#hidden_sort_type').val();
    var suppcode = $('#suppcodetemp').val(); 
    var suppdesc = $('#suppdesctemp').val(); 
    fetch_data(page, sort_type, column_name, suppcode, suppdesc);
