...
<div class="col-md-2 col-sm-4 offset-md-3 offset-lg-0">
...
<div class="col-12"><hr></div>
  ...
  <div class="col-12 form-group row">
      ...
      <div class="col-md-4 col-sm-4 offset-md-2 offset-lg-0">
...
<input type="hidden" id="itemcodetemp" value=""/>
<input type="hidden" id="itemdesctemp" value=""/>
<input type="hidden" id="itemtypetemp" value=""/>
  ...
  <div class="table-responsive col-12" style="overflow: auto; display: block;white-space: nowrap; margin-left: auto; margin-right: auto;">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
          <tr>
             <th width="15%" class="sorting" data-sorting_type="asc" data-column_name= "itemcode" style="cursor: pointer">Item Code<span id="name_icon"></span></th>
             <th width="20%" class="sorting" data-sorting_type="asc" data-column_name= "itemdesc" style="cursor: pointer">Item Description</th>
             <th width="15%" class="sorting" data-sorting_type="asc" data-column_name= "safety_stock" style="cursor: pointer">Safety Stock</th>  
             <th width="10%" class="sorting" data-sorting_type="asc" data-column_name= "item_um" style="cursor: pointer">UM</th>
	     <th width="20%" class="sorting" data-sorting_type="asc" data-column_name= "item_site" style="cursor: pointer">Site</th>
...
@section('scripts')
  ...
  $(document).on('click', '#btnsearch', function() {
    ...
    document.getElementById("itemcodetemp").value =itemcode;
    document.getElementById("itemdesctemp").value =itemdesc;
    document.getElementById("itemtypetemp").value =itemtype;
  ...
  $(document).on('click', '.pagination a', function(event) {
    ...
    var itemcode = $('#itemcodetemp').val(); 
    var itemdesc = $('#itemdesctemp').val(); 
