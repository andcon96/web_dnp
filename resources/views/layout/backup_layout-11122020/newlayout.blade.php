...
<body class="open">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
			...
			<i class="menu-icon fa fa-atlas"></i>Sales Order Sales</a>
			...
			<a href="{{url('/sosales')}}">Sales Order Sales</a></li>
                         @endif
 	                   </ul>
                    </li>
		    @endif

		    @if(str_contains( Session::get('menu_access'), 'TS01') || str_contains( Session::get('menu_access'), 'TS08') || str_contains( Session::get('menu_access'), 'TS05') || str_contains( Session::get('menu_access'), 'TS07') || str_contains( Session::get('menu_access'), 'TS09'))                    
		    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-book"></i>Sales Order</a>
                        <ul class="sub-menu children dropdown-menu">
                        
                       
                        @if(str_contains( Session::get('menu_access'), 'TS01'))
                        <li><i class="menu-icon fa fa-book"></i><a href="{{url('/menueof')}}">End Of Day</a></li>
                        @endif
                        ...
                        <li><i class="menu-icon fa fa-book"></i><a href="{{url('/sosad')}}">Sales Order SAD</a></li>
                        @endif
		    ...
		    @if(str_contains( Session::get('menu_access'), 'TS03')||str_contains( Session::get('menu_access'), 'TS04'))
                    <h3 class="menu-title">Toko</h3>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-globe"></i>Toko</a>
                        <ul class="sub-menu children dropdown-menu">
		...
		<h3 class="menu-title">PO Receipt</h3><!-- /.menu-title -->
                    
		    
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i 				class="menu-icon fa fa-book-open"></i>PO Receipt</a>
                        <ul class="sub-menu children dropdown-menu">
                        @if(str_contains( Session::get('menu_access'), 'TS02'))
