...
<!--- Submit EOD -->
<form method="post" action="/checksoqadweb">
  {{csrf_field()}}
  <div class="form-group row col-md-12">
    <label for="site" class="col-md-2 col-form-label text-md-right">{{ __('Site') }}</label>
      ...
      @else
      <div class="col-md-3">
        <input id="site" type="text" class="form-control" name="site" value="{{Session::get('site')}}" readonly required autofocus autocomplete="off">
      </div>
      @endif
